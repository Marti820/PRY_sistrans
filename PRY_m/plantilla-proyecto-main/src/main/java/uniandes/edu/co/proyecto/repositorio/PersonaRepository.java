...
public interface PersonaRepository extends JpaRepository<Persona, Integer> {
    ...
    Persona getPersonaByNumeroDocumento(@Param("numeroDocumento") int numeroDocumento);

    @Modifying
    @Transactional
    @Query(value = "INSERT INTO PERSONA (NUMERO_DOCUMENTO) VALUES (:numeroDocumento)", nativeQuery = true)
    void insertarPersona(@Param("numeroDocumento") int numeroDocumento);

    @Modifying
    @Transactional
    @Query(value = "DELETE FROM PERSONA WHERE NUMERO_DOCUMENTO = :numeroDocumento", nativeQuery = true)
    void eliminarPersona(@Param("numeroDocumento") int numeroDocumento);
